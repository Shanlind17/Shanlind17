$(function () {
  ...
  //  }
   ...
   //  }
    ...
    createPlatform(355, 455, 50, 20); 
    createPlatform(300, 409, 60, 20); 
    createPlatform(459, 490, 50, 20); 
    ...
    createCannon("left", 500, 1000); // cannon on right wall, 500px down, shooting once per second
